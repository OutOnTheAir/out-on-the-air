      ...
      <section style={{ padding: '3rem 2rem', maxWidth: '860px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.5rem' }}>
          {[
            ...
            { label: 'Bands', value: '160m through 6m · Satellite', note: 'The full HF spectrum plus 6 meters. 2m and 70cm are valid for satellite and ISS voice contacts only. General VHF/UHF SIMPLEX qualifies, repeaters do not qualify.' },
